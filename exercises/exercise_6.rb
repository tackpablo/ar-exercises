...
@store1.employees.create(first_name: "Tom", last_name: "Ford", hourly_rate: 75)
@store1.employees.create(first_name: "Tom", last_name: "Cruise", hourly_rate: 100)
@store2.employees.create(first_name: "Jane", last_name: "Doe", hourly_rate: 60)
@store2.employees.create(first_name: "Mary", last_name: "Jane", hourly_rate: 120)
...
@store5.employees.create(first_name: "James", last_name: "Bond", hourly_rate: 80)
@store6.employees.create(first_name: "Emma", last_name: "Stone", hourly_rate: 70)
@store6.employees.create(first_name: "Keira", last_name: "Knightly", hourly_rate: 90)